							...
							<div className='flex-1 min-w-0'>
								...
								<div className='flex items-center gap-2'>
									...
									{isTyping ? (
										...
										<div className='flex items-center gap-2'>
											<div className={`w-2 h-2 rounded-full ${isOnlineUser ? 'bg-green-600' : 'bg-gray-600'}`}></div>
											<span className={`text-sm font-medium ${isOnlineUser ? 'text-green-600' : 'text-gray-600'}`}>
