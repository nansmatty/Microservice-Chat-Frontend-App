		...
		<aside
			...
			<div className='p-6 border-b border-gray-700'>
				<div className='sm:hidden flex justify-end mb-0'>
					<button onClick={() => setSideBarOpen(false)} className='p-2 hover:br-gray-700 rounded-lg transition-colors'>
				...
				<div className='flex items-center justify-between'>
					...
					<button
						className={`p-2.5 rounded-lg transition-colors text-white ${
							showAllUsers ? 'bg-red-600 hover:bg-red-700' : 'bg-green-600 hover:bg-green-700'
						} `}
						...
						{chats.map((chat) => {
							...
							return (
								<button
									key={chat.chat._id}
									onClick={() => {
										setSeletedUser(chat.chat._id);
										setSideBarOpen(false);
									}}
									className={`w-full text-left p-4 rounded-lg transition-colors ${
										isSelected ? 'bg-blue-600 border border-blue-500' : 'border border-gray-700 hover:border-gray-600'
									}`}>
									<div className='flex items-center gap-3'>
										<div className='relative'>
